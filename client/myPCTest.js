...
var MountMixin = {
    componentDidUpdate: function(prevProps, prevState) {
        if (this.state.isPlaying && this.state.masterToggle) {
            if (!this.timer)
...
var StateMixin = {
  ...
  // window.masterToggle = this.state.masterToggle,
  ...
  handleAll: function() {
    this.setState({
      masterToggle: !this.state.masterToggle
    })
  },
  ...
  var pause = this.state.pause
        return (
            ...
            <OneClock pause={pause}/>
              ...
              <button className='reset-all' onClick={this.handlePauseAll.bind(this)}>Pause</button>
              </div>
            </div>
        );
    }
