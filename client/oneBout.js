...
var Bout = React.createClass({
  ...
  clockTickCallback: function(whichClock){
    if(!this.state.pause){
      var newState = {};
      newState[whichClock] = this.state[whichClock] - 10000;
      this.setState(newState);
    }
        ...
        <div>
          ...
          <div className="col-xs-6 col-sm-4 col-sm-offset-2 ">
            ...
            <div className="clock-button" style={{backgroundColor: this.state.color}}>
                <OneClock handleReset={this.handleResetClick.bind(this, 'clockOne')} handleClick={this.handleClockClick.bind(this, 'clockOne')} started={this.state.clockOneStarted} maxTicks={30000} ticks={this.state.clockOne} callbackInterval={1000} tickCallback={this.clockTickCallback.bind(this, 'clockOne')} />
            </div>
            <div className="clock-button" style={{backgroundColor: this.state.color}}>
                <OneClock handleReset={this.handleResetClick.bind(this, 'clockTwo')} handleClick={this.handleClockClick.bind(this, 'clockTwo')} started={this.state.clockTwoStarted} maxTicks={30000} ticks={this.state.clockTwo} callbackInterval={1000} tickCallback={this.clockTickCallback.bind(this, 'clockTwo')} />
            </div>
            <div className="clock-button" style={{backgroundColor: this.state.color}}>
